...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-[linear-gradient(135deg,hsl(var(--primary)),hsl(var(--primary))/0.88)] text-primary-foreground shadow-[0_18px_36px_-20px_hsl(var(--primary)/0.7)] hover:-translate-y-0.5 hover:brightness-[1.03] hover:shadow-[0_24px_42px_-20px_hsl(var(--primary)/0.78)]",
        ...
        outline: "border border-input/80 bg-background/82 shadow-sm hover:-translate-y-0.5 hover:border-primary/22 hover:bg-accent/82 hover:text-accent-foreground",
