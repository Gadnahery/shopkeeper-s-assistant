...
import { Barcode, Search, CheckCircle, Printer, Save, Minus, Plus, X, Loader2, Camera } from "lucide-react";
    ...
    <>
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="grid gap-4 md:gap-6 lg:grid-cols-4">
        <div className="space-y-4 md:space-y-6 lg:col-span-3">
          ...
          {/* Search / Barcode */}
          <div className="grid gap-4 md:grid-cols-2">
            <Card className="cursor-pointer" onClick={() => setShowScanner(true)}>
            ...
            <CardContent className="p-4 md:p-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <div className="relative flex-1">
                        <Input value={discountAmount} onChange={e => { setDiscountAmount(e.target.value); setDiscountPercent("0"); }} className="pr-12" />
                      ...
                      <div className="relative flex-1">
                        <Input value={discountPercent} onChange={e => { setDiscountPercent(e.target.value); setDiscountAmount("0"); }} className="pr-8" />
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-3">
                <div className="space-y-2">
                  ...
                  <Input value={cashAmount} onChange={e => setCashAmount(e.target.value)} placeholder={formatNumber(total)} />
                </div>
                <div className="space-y-2">
                  <Label className="text-muted-foreground">{t("sales.mpesa")}</Label>
                  <Input value={mpesaAmount} onChange={e => setMpesaAmount(e.target.value)} placeholder={t("sales.enterAmount")} />
                </div>
                <div className="space-y-2">
                  <Label className="text-muted-foreground">{t("sales.mpesaCode")}</Label>
                  <Input value={mpesaCode} onChange={e => setMpesaCode(e.target.value)} placeholder={t("sales.transactionCode")} />
                </div>
              </div>
