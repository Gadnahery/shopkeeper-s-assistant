      ...
      <Dialog open={!!editing} onOpenChange={(o) => !o && setEditing(null)}>
        <DialogContent>
          ...
          <div className="space-y-4 pt-4">
            ...
            <Button className="w-full" onClick={handleSave} disabled={!form.name || updateCat.isPending}>
      ...
      <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
        <DialogContent>
          ...
          <div className="space-y-4 pt-4">
            ...
            <Button className="w-full" onClick={handleSave} disabled={!form.name || createCat.isPending}>
                    ...
                    <TableRow key={cat.id}>
                      ...
                      <TableCell className="text-right">
                        <div className="flex justify-end gap-1">
                          ...
                          <Button variant="ghost" size="icon" className="h-8 w-8 text-destructive" onClick={() => deleteCat.mutate(cat.id)} disabled={deleteCat.isPending}>
