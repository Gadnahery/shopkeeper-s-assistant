...
DROP POLICY IF EXISTS "tod_s" ON public.todos;
DROP POLICY IF EXISTS "tod_i" ON public.todos;
DROP POLICY IF EXISTS "tod_u" ON public.todos;
DROP POLICY IF EXISTS "tod_d" ON public.todos;
